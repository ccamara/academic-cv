...
{{< figure library="1" src="cadaveres_workflow.png" caption="Workflow Cadáveres Inmobiliarios. Fuente: Pablo Rey." >}}
...
{{< figure library="1" src="cadaveres_workflow_new.png" caption="Nuevo Workflow Cadáveres Inmobiliarios. Fuente: Pablo Rey." >}}
...
{{< x user="numeroteca" id="776099956566417408" >}}

{{< x user="skotperez" id="776079936226492418" >}}
...
{{< x user="skotperez" id="776441122650480640" >}}
...
{{< figure src="photo_2018-02-06_23-36-28.jpg" caption="Alfonso Sánchez explicando qué es una API y cómo funciona" >}}
