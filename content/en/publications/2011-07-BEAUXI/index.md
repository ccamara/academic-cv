...
publishDate: 2011-07-21 00:00:00
publication_types:
- book-chapter
...
links:
- type: preprint
  url: textos_maquetados_libro.pdf
projects:
- web-beauxi
slides: ''
draft: false
...
The following text is an excerpt from the material we produced for the book accompanying the [11th Spanish Biennial of Architecture and Urbanism (BEAUXI)](http://bienalesdearquitectura.es/index.php/es/archivo-xi-beau.html)—a collaborative effort by Ethel Baraona, Pablo García Bachiller, and myself as members of the documentation, dissemination, and web transparency team. The aim of these texts was to explain our work while offering a different, more intimate perspective on another viewpoint: the one presented by the BEAU through its selection of projects.
